...
public class WeaponsFactory {
        ...
        defineWeapons[2] = new Weapons(4, " An Arrow that fires a deadly chemical strike.", "Poison Arrow");
        defineWeapons[2].setDamage(6);

        defineWeapons[3] = new Weapons(5, " A strong electricity Attack that can kill an enemy monster with a single shot.", "lightning thunder strike");
        defineWeapons[3].setDamage(8);
        
        defineWeapons[4] = new Weapons(6, " A Rifle that can aim and shot at a monster's most valnuable place, ex. right at it's head.", "Sniper Rifle");
